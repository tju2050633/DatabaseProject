  ...
  <div class="mainPage">
    ...
    <el-header>
      <el-row :span="24">
        ...
        <el-col :span="2" class="logo-text"> 共享花园 </el-col>
        ...
        <el-col :span="1" :offset="5">
          <el-dropdown>
            ...
            <template v-slot:dropdown>
              <el-dropdown-menu>
                <el-dropdown-item @click="this.$router.push()"
    ...
    <div class="item-block">
      <el-row v-for="i in blockData.length" :key="i" :span="24">
        <el-col :span="6" v-for="o in 3" :key="o" :offset="o == 0 ? 3 : 1">
          <el-card shadow="hover">
            <img
              src="https://img2.baidu.com/it/u=1903252484,200684433&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500"
              class="image"
            />
  ...
  data() {
    return {
      ...
      promoList: [
        {
          value: "photo",
          src: "https://img2.baidu.com/it/u=515617864,988567067&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500",
          url: "https://www.baidu.com",
        },
        {
          value: "photo",
